  ...
  return (
    <div className="rounded-xl bg-white shadow-sm">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-xl px-6 py-4 text-left transition-colors hover:bg-slate-50"
      >
...
function TraceStepItem({
  ...
  return (
    <li className="relative pl-8">
      {/* Checkmark node */}
      <div
        className="absolute left-0 flex h-6 w-6 items-center justify-center rounded-full bg-emerald-100"
        aria-hidden="true"
      >
        <svg
        ...
        {expanded && (
          <div className="mt-2 space-y-2 rounded-lg bg-slate-50 p-3 text-xs">
            <div>
              ...
              <span className="text-slate-700">{step.input_summary}</span>
            </div>
            <div>
              <span className="font-medium text-slate-500">Output: </span>
              <span className="text-slate-700">{step.output_summary}</span>
            </div>
            <div>
